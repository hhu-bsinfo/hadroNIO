...
public class LatencyResult {
    ...
    public void writeToFile(final String fileName, final String benchmarkName, final int iteration) throws IOException {
        ...
        if (file.exists()) {
            ...
            writer.write("Benchmark,Iteration,Size,OperationThroughput,AverageLatency,MinimumLatency,MaximumLatency,50thLatency,95thLatency,99thLatency,999thLatency,9999thLatency\n");
        }
